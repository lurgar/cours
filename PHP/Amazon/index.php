                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="single_article/index.php?idproduct=<php echo single_product['id_product'];?>">Ajouter au panier </a></div>
                            </div>
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="single_article/index.php?idproduct=<php echo single_product['id_product'];?>">fiche produit</a></div>
                            </div>
                        </div>
