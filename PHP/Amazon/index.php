                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                         ...
                         <?php } ?> 
                            ...
                            <!-- Product image-->
                            <img style="height: 330px;" class="card-img-top" src="backoffice/img/upload/<?php echo $productsingle['image'];?>" alt="..." />
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="single_article/index.php?id_product=<?php echo $productsingle['id_product'];?>">Ajouter au panier </a></div>
                            </div>
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class=" btn-outline-dark mt-auto" href="single_article/index.php?id_product=<?php echo $productsingle['id_product'];?>">fiche produit</a></div>
                            </div>
                        </div>
